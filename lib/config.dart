...
// const String apiUrl = 'http://52.231.106.232:8000';//프로덕션 환경(안드로이드) 
const String apiUrl = 'http://10.0.2.2:8000';//디버그 환경(안드로이드)
// const String apiUrl = 'http://127.0.0.1:8000';//디버그 환경(안드로이드)
